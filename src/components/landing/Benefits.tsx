const features = [
    {
        ...
        illustration: '/assets/illustrations/smart-reminder.png',
        colSpan: 'col-span-5',
        bgPosition: 'bg-top',
    },
    {
        bg: 'bg-[url(\'./assets/bg/ellipse-pale-pink.svg\')]',
        icon: '/assets/icons/purple-heart.svg',
        ...
        illustration: '/assets/illustrations/task-recommendation.png',
        colSpan: 'col-span-7',
    ...
    },
    {
        ...
        illustration: '/assets/illustrations/smart-partner.svg',
        colSpan: 'col-span-4 max-xl:col-span-6',
        bgPosition: 'bg-[left_top_-4rem]',
    },
    {
        bg: '',
        icon: '/assets/icons/purple-heart-alt.svg',
