...
import { useAddTodoItem } from "../../../hooks/lists/useAddTodoItem";
...
export const TodoList = ({ list }: { list: any }) => {
    ...
    const { isAddingItem } = useAddTodoItem();
    const { handleAddItem, handleInputChange, handleSaveItems, handleNewInput, handleKeyMap, newItems, inputingItem } = useTodoList(list.id);
                ...
                <div className="text-white w-full">
                    ...
                    {newItems.map((item, index) => (
                        <div key={index} className="flex items-center p-4 rounded">
                            ...
                            />
                            <button onClick={() => handleNewInput(index)}>
