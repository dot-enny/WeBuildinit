        ...
        <li className="bg-[#393B3C] flex items-center p-4 rounded">
            ...
            <div className="ml-auto relative">
                ...
                <div className="text-white grid grid-cols-2 items-center gap-x-3">
                    ...
                    <button onClick={() => getListItems(list.id)} className="relative cursor-pointer" disabled={isLoading}>
                    ...
                    <button onClick={() => deleteList(list.id)} className="relative cursor-pointer">
